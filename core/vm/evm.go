...
func (evm *EVM) CallCode(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int) (ret []byte, leftOverGas uint64, err error) {
	...
	if contract.CodeAddr != nil {
		if p := PlatONPrecompiledContracts[*contract.CodeAddr]; p != nil {
			log.Info("collect embed PlantON precompiled contract tx in CallCode()", "blockNumber", evm.Context.BlockNumber.Uint64(), "from", caller.Address().Bech32(), "to", to.Address().Bech32())
			common.CollectEmbedContractTx(evm.Context.BlockNumber.Uint64(), evm.StateDB.TxHash(), caller.Address(), to.Address(), input)
		}
	}
	return ret, contract.Gas, err
...
func (evm *EVM) DelegateCall(caller ContractRef, addr common.Address, input []byte, gas uint64) (ret []byte, leftOverGas uint64, err error) {
	...
	if contract.CodeAddr != nil {
		if p := PlatONPrecompiledContracts[*contract.CodeAddr]; p != nil {
			log.Info("collect embed PlantON precompiled contract tx in DelegateCall()", "blockNumber", evm.Context.BlockNumber.Uint64(), "from", caller.Address().Bech32(), "to", to.Address().Bech32())
			common.CollectEmbedContractTx(evm.Context.BlockNumber.Uint64(), evm.StateDB.TxHash(), caller.Address(), to.Address(), input)
		}
	}
...
func (evm *EVM) StaticCall(caller ContractRef, addr common.Address, input []byte, gas uint64) (ret []byte, leftOverGas uint64, err error) {
	...
	if contract.CodeAddr != nil {
		if p := PlatONPrecompiledContracts[*contract.CodeAddr]; p != nil {
			log.Info("collect embed PlantON precompiled contract tx in StaticCall()", "blockNumber", evm.Context.BlockNumber.Uint64(), "from", caller.Address().Bech32(), "to", to.Address().Bech32())
			common.CollectEmbedContractTx(evm.Context.BlockNumber.Uint64(), evm.StateDB.TxHash(), caller.Address(), to.Address(), input)
		}
	}
